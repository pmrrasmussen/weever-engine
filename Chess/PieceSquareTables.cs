...
public partial class Board
{
    ...
    private static readonly int[] PawnMiddlegameTable =
    [
          0,   0,   0,   0,   0,   0,  0,   0,
    ...
    private static readonly int[] KnightMiddlegameTable =
    [
    ...
    private static readonly int[] KnightEndgameTable =
    [
    ...
    private static readonly int[] BishopMiddlegameTable =
    [
    ...
    private static readonly int[] BishopEndgameTable =
    [
    ...
    private static readonly int[] RookMiddlegameTable =
    [
    ...
    private static readonly int[] RookEndgameTable =
    [
    ...
    private static readonly int[] QueenMiddlegameTable =
    [
    ...
    private static readonly int[] QueenEndgameTable =
    [
    ...
    private static int[] PadTable(int[] table)
    {
        var paddedTable = new List<int>();
        paddedTable.AddRange(Enumerable.Repeat(0, 20));

        for (int i = 0; i < 64; i += 8)
        {
            paddedTable.Add(0);
            paddedTable.AddRange(table[i..(i+8)]);
            paddedTable.Add(0);
        }

        paddedTable.AddRange(Enumerable.Repeat(0, 20));

        return paddedTable.ToArray();
    }
}
